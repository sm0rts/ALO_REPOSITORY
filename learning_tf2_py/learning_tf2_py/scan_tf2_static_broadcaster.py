...
class StaticFramePublisher(Node):
    ...
    def __init__(self, transformation):
        super().__init__('scan_tf2_static_broadcaster')
        ...
        self.scanner = self.declare_parameter(
            'scannername', 'scanner').get_parameter_value().string_value
        
        self.subscription = self.create_subscription(
            LaserScan,
            f'/{self.scanner}/msg',
            self.handle_scanner_msg,
            1)
        self.subscription
